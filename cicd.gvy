    ...
    stages {
        stage('compile') {
	         steps {
                // step1 
                echo 'compiling..'
		            git url: 'https://github.com/tkashwintk/PetClinic'
        ...
        stage('build & push docker image') {
	         steps {
              withDockerRegistry(credentialsId: 'DOCKER_HUB_LOGIN', url: 'https://index.docker.io/v1/') {
                    ...
                    sh script: 'docker build --file Dockerfile --tag docker.io/tkashwintk/petclinic:$BUILD_NUMBER .'
                    sh script: 'docker push docker.io/tkashwintk/petclinic:$BUILD_NUMBER'
              }	
           }		
        }
    stage('Deploy-App-QA') {
